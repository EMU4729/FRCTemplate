...
public class RobotContainer {
  ...
  private final DifferentialDriveSub driveSubsystem = new DifferentialDriveSub();
  private final PhotonVisionSubsystem photonSubsystem = new PhotonVisionSubsystem();
  /**
  ...
  public Command getAutonomousCommand() {
    return new AutoDriveCommand(driveSubsystem, photonSubsystem);
  }
}
